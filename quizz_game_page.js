...
function send() {
    ...
    check_button = " <br><br><button type='button' id='check_button' style=' color:black; background-color: rgb(125, 170, 107); color:rgb(0, 0, 0); width: 200px; height: 30px; border-radius: 3px; font-family: Franklin Gothic Medium, Arial Narrow, Arial, sans-serif; border-style: none;' onclick =check()>CHECK</button> <br><br>";
